...
const Header = () => {
  return (
    <>
    <TopHeader />
    <header className="text-gray-600 body-font sm:mt-4 mt-10 border-b-2 border-slate-300">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center gap-5">
          <a className="mr-5 hover:text-gray-900 hover:border-b-2 border-blue-500">Home</a>
          <a className="mr-5 hover:text-gray-900 hover:border-b-2 border-blue-500">Contact</a>
          <a className="mr-5 hover:text-gray-900 hover:border-b-2 border-blue-500">About</a>
          <a className="mr-5 hover:text-gray-900 hover:border-b-2 border-blue-500">Signup</a>
        </nav>
        <div className="flex items-center py-1 px-3 sm:px-1 mt-4 md:mt-0 sm:gap-5 gap-2 w-full md:w-auto">
          <div className="flex items-center border border-gray-100 rounded-md shadow-sm sm:w-full ">
            <input
              type="text"
              className="flex-grow px-6 py-1 rounded-l-md focus:outline-none focus:ring-2 focus:ring-indigo-500  placeholder:text-sm"
